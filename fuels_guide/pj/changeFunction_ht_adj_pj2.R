...
d <- read.csv('C:\\Users\\User\\Documents\\GitHub\\thesis\\fuels_guide\\pj\\data_20180427121332.csv', header = TRUE)
...
data <- select(d, c(subplot_id, scode, rcode, treatment, sp_phase, year,  
                    ...
                    cover_shrub_ARNO4 = can_cover_ARNO4,
                    ...
                    loading_shrub_ARNO4 = shrub_bio_ttl_ARNO4,
                    ...
                    bulkDns_shrub_ARNO4 = shrub_bd_ARNO4,
...
###########################################################################################################alter for each region/phase/treatment
scode <- c('SV', 'MC') #specify site codes
y_imp <- c(7, 6)          #specify year of implementation for sites      
data <- clean_subset(data, region = 'PJ', phase = '3', treatment1 = 'ME', scode = scode, y_imp = y_imp)
...
d$Component <- factor(d$Component, levels = c('JUOS', 'PIED', 'CELE3', 'ARNO4', 'ARTRW8', 'CHVI8', 'PUTR2', 'pgrass', 'agrass', 'grass', 'forb', 'iLitter', 'bground',
...
write.xlsx(d, file = 'C:\\Users\\User\\Documents\\GitHub\\thesis\\fuels_guide\\PJ\\fuel_table_tidy_pj.xlsx', 
           sheetName = 'pj_me_3', 
           append = TRUE)
