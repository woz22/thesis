...
url<- 'https://waterdata.usgs.gov/nwis/dv?cb_00010=on&cb_00060=on&format=rdb&site_no=13190500&referred_module=sw&period=&begin_date=2012-10-01&end_date=2013-09-30'
url_fire <- 'https://waterdata.usgs.gov/nwis/dv?cb_00010=on&cb_00060=on&format=rdb&site_no=13190500&referred_module=sw&period=&begin_date=2013-10-01&end_date=2014-09-30'
...
p <- p + labs(colour = "Year", title = 'Discharge of South Fork Boise River after Anderson Ranch Dam',
