...
dmethod(m, pfunc = "-b2/b3", pname = c("b2", "b3"))
```
...
####2. Repeat the previous proble, but use a marginal model approach, estimating the parameters using generalized estimating equations using geeglm().
