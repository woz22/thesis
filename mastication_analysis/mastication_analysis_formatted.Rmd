---
title: "Masticated Fuels Analyses: Square Root Transformation of Response Variables"
author: "Sam Wozniak"
date: "June 6, 2018"
output:
  pdf_document: 
...
Sampling at 5-6 years: 2/3 sites (GR, SC) were sampled 5 years since treatment, and 1 site (ON) was sampled at 6 years post-treatment

##Model
```{r}
m <- lmer(sqrt(dwd_1hr) ~ pre_tree_cvr + yst + pre_tree_cvr:yst + 
            (1|site), data = d)
```
...
p <- ggplot(data = d, aes(x = pre_tree_cvr, y = sqrt(dwd_1hr)))
p <- p + geom_jitter()
...
p <- ggplot(data = d, aes(x = pre_tree_cvr, y = sqrt(dwd_1hr), color = site))
p <- p + geom_jitter()
p <- p + geom_line(aes(y = yhat1))
p <- p + theme_classic()
...
##Model
```{r}
m <- lmer(sqrt(dwd_10hr) ~ pre_tree_cvr + yst + pre_tree_cvr:yst + 
            (1|site), data = d)
```
...
p <- ggplot(data = d, aes(x = pre_tree_cvr, y = sqrt(dwd_10hr)))
p <- p + geom_jitter()
...
#by yst and site
d$yhat10 <- predict(m)
p <- ggplot(data = d, aes(x = pre_tree_cvr, y = sqrt(dwd_10hr), color = site))
p <- p + geom_jitter()
p <- p + geom_line(aes(y = yhat10))
p <- p + theme_classic()
...
##Model
```{r}
m <- lmer(sqrt(dwd_100_1000hr) ~ pre_tree_cvr + factor(yst) + pre_tree_cvr:factor(yst) + 
            (1|site), data = d)
```
...
p <- ggplot(data = d, aes(x = pre_tree_cvr, y = sqrt(dwd_100_1000hr)))
p <- p + geom_jitter()
...
p <- ggplot(data = d, aes(x = pre_tree_cvr, y = sqrt(dwd_100_1000hr), color = site))
p <- p + geom_jitter()
p <- p + geom_line(aes(y = yhat100_1000))
p <- p + theme_classic()
p <- p + facet_wrap(site~yst)
...
##Model
```{r}
m <- lmer(sqrt(duff) ~ factor(yst) + pre_tree_cvr + factor(yst):pre_tree_cvr + 
            (1|site), data = d)
```
...
p <- ggplot(data = d, aes(x = pre_tree_cvr, y = sqrt(duff)))
p <- p + geom_jitter()
...
p <- ggplot(data = d, aes(x = pre_tree_cvr, y = sqrt(duff), color = site))
p <- p + geom_jitter()
p <- p + geom_line(aes(y = yhat_duff))
...
##Model
```{r}
m <- lmer(sqrt(herb_ttl) ~ TDI + factor(yst) + factor(yst):TDI + 
            (1|site), data = l)
```
...
p <- ggplot(data = l, aes(x = TDI, y = sqrt(herb_ttl)))
p <- p + geom_point()
...
p <- ggplot(data = l, aes(x = TDI, y = sqrt(herb_ttl), color = site))
p <- p + geom_point()
p <- p + geom_line(aes(y = yhat_herb))
p <- p + theme_bw()
p <- p + labs(title = 'Herbaceous Fuels',
...
##Model
```{r}
m <- lmer(sqrt(shrub_fuel) ~ TDI + factor(yst) + factor(yst):TDI + 
            (1|site), data = l2)
```
...
p <- ggplot(data = l2, aes(x = TDI, y = sqrt(shrub_fuel)))
p <- p + geom_jitter()
...
p <- ggplot(data = l2, aes(x = TDI, y = sqrt(shrub_fuel), color = site))
p <- p + geom_point()
p <- p + geom_line(aes(y = yhat_shrub))
p <- p + theme_bw()
p <- p + labs(title = 'Shrub Fuels',
...
##Model
```{r}
m <- lmer(sqrt(can_cover_pt_shrub) ~ TDI + factor(yst) + factor(yst):TDI + 
            (1|site), data = l)
```
...
p <- ggplot(data = l, aes(x = TDI, y = sqrt(can_cover_pt_shrub)))
p <- p + geom_point()
...
##Model
```{r}
m <- lmer(sqrt(can_cover_pt_pgrass) ~ TDI + factor(yst) + factor(yst):TDI + 
            (1|site), data = l)
```
...
p <- ggplot(data = l, aes(x = TDI, y = sqrt(can_cover_pt_pgrass)))
p <- p + geom_jitter()
...
p <- ggplot(data = l, aes(x = TDI, y = sqrt(can_cover_pt_pgrass), color = site))
p <- p + geom_point()
p <- p + geom_line(aes(y = yhat_pgrass_cvr))
p <- p + theme_bw()
p <- p + labs(title = 'Perennial Tall Grass Cover',
...
##Model
```{r}
m <- lmer(sqrt(can_cover_pt_agrass) ~ TDI + factor(yst) + factor(yst):TDI + 
            (1|site), data = l)
```
...
p <- ggplot(data = l, aes(x = TDI, y = sqrt(can_cover_pt_agrass)))
p <- p + geom_point()
...
p <- ggplot(data = l, aes(x = TDI, y = sqrt(can_cover_pt_agrass), color = site))
p <- p + geom_point()
p <- p + geom_line(aes(y = yhat_agrass_cvr))
p <- p + theme_bw()
p <- p + labs(title = 'Annual Grass Cover',
...
```{r}
m <- lmer(sqrt(tree_dns_lt5) ~ TDI + factor(yst) + factor(yst):TDI + (1|site), 
          data = td)
```
...
##Model
```{r}
m <- lmer(sqrt(tree_dns_gt50) ~ TDI + factor(yst) + factor(yst):TDI + (1|site), 
          data = td)
```
...
p <- ggplot(data = td, 
            aes(x = TDI, y = sqrt(tree_dns_gt50)))
p <- p + geom_point()
p <- p + theme_bw()
...
```{r}
m <- lmer(sqrt(tree_cover_ttl) ~ TDI + factor(yst) + factor(yst):TDI + (1|site), 
          data = tcover)
```
...
p <- ggplot(data = tcover, aes(x = TDI, y = sqrt(tree_cover_ttl)))
p <- p + geom_jitter()
...
p <- ggplot(data = tcover, aes(x = TDI, y = sqrt(tree_cover_ttl), color = site))
p <- p + geom_jitter()
p <- p + geom_line(aes(y = yhat_tree_cover))
p <- p + theme_bw()
p <- p + labs(title = 'Tree Cover',
