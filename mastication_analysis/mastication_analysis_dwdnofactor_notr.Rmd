...
```{r}
m <- lmer(kgha_1h ~ TC + yst + TC:yst + (1 + yst|scode), data = d)
summary(m)
lincon(m)
...
p <- ggplot(data = d, aes(x = TC, y = kgha_1h))
p <- p + geom_jitter()
...
#by yst and scode
p <- ggplot(data = d, aes(x = TC, y = kgha_1h, color = scode))
p <- p + geom_jitter()
p <- p + geom_line(aes(y = yhat1))
p <- p + theme_classic()
...
```{r}
m <- lmer(kgha_10h ~ TC + yst + TC:yst + (1 + yst|scode), data = d)
summary(m)
lincon(m)
...
p <- ggplot(data = d, aes(x = TC, y = kgha_10h))
p <- p + geom_jitter()
...
#by yst and scode
d$yhat10 <- predict(m)
p <- ggplot(data = d, aes(x = TC, y = kgha_10h, color = scode))
p <- p + geom_jitter()
p <- p + geom_line(aes(y = yhat10))
p <- p + theme_classic()
...
```{r}
m <- lmer(kgha_100_1000h ~ TC + yst + TC:yst + (1 + yst|scode), data = d)
summary(m)
lincon(m)
...
p <- ggplot(data = d, aes(x = TC, y = kgha_100_1000h))
p <- p + geom_jitter()
...
p <- ggplot(data = d, aes(x = TC, y = kgha_100_1000h, color = scode))
p <- p + geom_jitter()
p <- p + geom_line(aes(y = yhat100_1000))
p <- p + theme_classic()
p <- p + facet_wrap(scode~yst)
...
m <- lmer(duff ~ yst + pre_tc + yst:pre_tc + (1 + yst|scode), data = d)
summary(m)
lincon(m)

#by yst
d$yhat_duff <- predict(m, re.form = NA)
p <- ggplot(data = d, aes(x = pre_tc, y = duff))
p <- p + geom_jitter()
...
qqnorm(resid(m)); qqline(resid(m))
ggplot(m, aes(x = .fitted, y = .resid)) + geom_point() + facet_wrap(~yst) + scale_x_continuous(limits = c(0, 2000))

#by yst and site
d$yhat_duff <- predict(m)
p <- ggplot(data = d, aes(x = pre_tc, y = duff, color = scode))
p <- p + geom_jitter()
p <- p + geom_line(aes(y = yhat_duff))
p <- p + theme_classic() + facet_wrap(scode~yst, ncol = 2)
p <- p + labs(title = 'Tree Litter + Duff',
...
```{r}
m <- lmer(herb_ttl ~ TDI + yst + yst:TDI + (1 + yst|scode), data = l)
...
m <- lmer(shrub_fuel ~ TDI + yst + yst:TDI + (1 + yst|scode), data = l)
summary(m)
lincon(m)

#by yst
l$yhat_shrub <- predict(m, re.form = NA)
p <- ggplot(data = l, aes(x = TDI, y = shrub_fuel))
p <- p + geom_point()
...
p <- ggplot(data = l, aes(x = TDI, y = shrub_fuel, color = scode))
p <- p + geom_point()
p <- p + geom_line(aes(y = yhat_shrub))
p <- p + theme_bw()
p <- p + labs(title = 'Shrub Fuels',
...
```{r}
m <- lmer(can_cover_pt_pgrass ~ TDI + yst + yst:TDI + (1 + yst|scode), data = l)
summary(m)
lincon(m)
...
p <- ggplot(data = l, aes(x = TDI, y = can_cover_pt_pgrass, color = scode))
p <- p + geom_point()
p <- p + geom_line(aes(y = yhat_pgrass_cvr))
p <- p + theme_bw()
p <- p + labs(title = 'Perennial Tall Grass Cover',
...
```{r}
m <- lmer(can_cover_pt_agrass ~ TDI + yst + yst:TDI + (1 + yst|scode), data = l)
summary(m)
lincon(m)

#by yst
l$yhat_agrass_cvr <- predict(m, re.form = NA)
p <- ggplot(data = l, aes(x = TDI, y = can_cover_pt_agrass, color = scode))
p <- p + geom_point()
...
```{r}
m <- lmer(tree_dns_gt50_JUOS + tree_dns_gt50_PIED ~ 
...
p <- ggplot(data = td, aes(x = TC, 
                           y = tree_dns_gt50_JUOS + tree_dns_gt50_PIED))
p <- p + geom_point()
p <- p + theme_bw()
...
m <- lmer(tree_cover_ttl ~ TC + yst + yst:TC + (1 + yst|scode), data = tcover)
summary(m)
lincon(m)

#by yst
tcover$yhat_tree_cover <- predict(m)
p <- ggplot(data = tcover, aes(x = TC, y = tree_cover_ttl))
p <- p + geom_jitter()
...
p <- p + facet_wrap(scode~yst, ncol = 2)
plot(p)
...
#by yst and site
tcover$yhat_tree_cover <- predict(m)
p <- ggplot(data = tcover, aes(x = TC, y = tree_cover_ttl, color = scode))
p <- p + geom_jitter()
p <- p + geom_line(aes(y = yhat_tree_cover))
p <- p + theme_bw()
p <- p + labs(title = 'Tree Cover',
